...
public enum RecommendationChannelType {
    ...
    RECOMMENDED_LIST(Map.ofEntries(
            ...
            entry(RELEVANCE_PUBLICATION_DATE_RECENT, BigDecimal.valueOf(0)),
            entry(RELEVANCE_PUBLICATION_DATE_RELEVANT, BigDecimal.valueOf(0)),
            entry(RELEVANCE_UPDATE_DATE_RECENT, BigDecimal.valueOf(0)),
            entry(RELEVANCE_QUESTION_HAS_ANSWER, BigDecimal.valueOf(0)),
            entry(RELEVANCE_QUESTION_PER_ANSWER, BigDecimal.valueOf(0)),
            entry(RELEVANCE_QUESTION_HAS_BEST_ANSWER, BigDecimal.valueOf(0)),
            entry(RELEVANCE_DUPLICATE_QUESTION, BigDecimal.valueOf(0)),
            entry(RELEVANCE_QUESTION_NUMBER_VIEWS, BigDecimal.valueOf(0)),
            entry(RELEVANCE_QUESTION_NUMBER_FOLLOWERS, BigDecimal.valueOf(0)),
            ...
            entry(RELEVANCE_USER_ALREADY_ANSWERED, BigDecimal.valueOf(0)),
            entry(RELEVANCE_USER_ALREADY_COMMENTED, BigDecimal.valueOf(0)),
            ...
            entry(RELEVANCE_QUESTIONS_ASKED_IN_TAG, BigDecimal.valueOf(0)),
            entry(RELEVANCE_QUESTIONS_ANSWERED_IN_TAG, BigDecimal.valueOf(0)),
            entry(RELEVANCE_QUESTIONS_COMMENTED_IN_TAG, BigDecimal.valueOf(0)),
            entry(RELEVANCE_QUESTIONS_VIEWED_IN_TAG, BigDecimal.valueOf(0)),
            entry(RELEVANCE_QUESTIONS_FOLLOWED_IN_TAG, BigDecimal.valueOf(0)),
